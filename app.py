...
# Auto-generate Question if not already generated AND start story exists
...
# ----------------------------------------------------
# STEP 6: Auto AI Decision Point + User Decision
# ----------------------------------------------------
...
# Auto-generate Decision Point once Step 5 exists
...
decision_taken = st.text_input(
    "Enter your decision:",
    "They decide to follow the hidden path."
)
...
# ----------------------------------------------------
# STEP 9: FULL STORY GENERATION (UNLIMITED LENGTH)
# ----------------------------------------------------
...
- End well do not question anything just give story
Inputs:
